      ...
      <div className="w-full bg-black text-white h-screen font-bold flex flex-col max-w-xl">
        <div className="px-4 z-10">
          <div className="flex items-center space-x-2 pt-4">
            ...
            <div>
              <p className="text-sm">Kabiru (CEO)</p>
            </div>
          </div>
          <div className="flex items-center justify-between space-x-4 mt-1">
            ...
            <div className="flex items-center w-2/3 border-2 border-[#43433b] rounded-full px-4 py-[2px] bg-[#43433b]/[0.6] max-w-64">
              <img src={images.binanceLogo} alt="Exchange" className="w-8 h-8" />
              <div className="h-[32px] w-[2px] bg-[#43433b] mx-2"></div>
              <div className="flex-1 text-center">
                <p className="text-xs text-[#85827d] font-medium">Profit per hour</p>
                <div className="flex items-center justify-center space-x-1">
                  <img src={images.dollarCoin} alt="Dollar Coin" className="w-[18px] h-[18px]" />
            ...
            <div className="px-4 mt-4 flex justify-center">
              ...
              >
                <div className="w-full h-full rounded-full circle-inner">
                  <img src={images.proseedLogo} alt="Main Character" className="w-full h-full" />
                </div>
              </div>
            </div>
          </div>
